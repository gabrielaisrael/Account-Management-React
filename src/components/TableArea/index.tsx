        ...
        <T.table>
            <thead>
                <tr>
                    ...
                    <T.theadColumn width={150}>סכום</T.theadColumn>
                    <T.theadColumn>שם</T.theadColumn>
                    <T.theadColumn width={140}>סוג</T.theadColumn>
                    <T.theadColumn width={100}>תאריך</T.theadColumn>
